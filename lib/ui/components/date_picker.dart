...
class StyledTextFieldDatePicker extends StatefulWidget {
...
class _MyTextFieldDatePicker extends State<StyledTextFieldDatePicker> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(widget.title, style: AppTextStyles.Body1.bold),
        VtSpace(10),
        TextField(
